...
<div class="wrapper-main">
	...
	<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3">Passport Number</h1>
			<div class="breadcrumb-main">
				<ol class="breadcrumb">
					<li class="breadcrumb-item">
						<a href="home.php">Home</a>
					</li>
					<li class="breadcrumb-item active">Passport Number</li>
				</ol>
			</div>
		</div>
	</div>
    ...
    <div class="container">
		...
		<form name="sentMessage" id="contactForm" novalidate>
            <div class="control-group form-group">
				<div class="controls">
   					<input type="text" placeholder="Enter Passport Number" class="form-control" id="name" name='PN' required data-validation-required-message="Please enter Passport Number.">
        ...
        <?php
             ...
             if (isset($_GET['PN'])) {
                $pn=$_GET['PN'];
                if($pn!=NULL){
                    $sql_fn="SELECT passportno,fname,m,lname,address,phone,sex,age from passenger2 where passportno = '".$pn."'";
                }
                else{
    ...
    <div class="container">
    		...
    		<form name="sentMessage" id="contactForm" novalidate>
                <div class="control-group form-group">
    				<div class="controls">
                        <center><a class='btn btn-lg btn-secondary btn-button' href='blog-post.php?PN=0'>Clear Data</a></center>
    				</div>
    			</div>
    		</form>
    </div>
