...
<div class="wrapper-main">
    ...
    <div class="container">
		...
		<!-- Content Row -->
			<h2><u><center>Arrived Flights</center></u></h2>
			<h4><center>
			    <?php
			        ...
			        $sql = "SELECT arrival,airlineid,destination,source,destination FROM flight ORDER BY arrival ";
						...
						<?php
                            ...
                            if(mysqli_num_rows($result) > 0){
                                while($row = $result->fetch_assoc()) {
                                    if($tm>$row['arrival'] and $row['destination']=='BOM'){
